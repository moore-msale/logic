            ...
            <div class="pt-lg-0 pt-5">
                ...
                <div class="mt-4 text-center">
                    ...
                    <div class="row justify-content-center pt-3">
                        ...
                        <img data-aos="fade-up" src="{{asset('images/proliant.jpg')}}" alt="">
                        ...
                        <img data-aos="fade-up" src="{{asset('images/hpe.jpg')}}" alt="">
                        ...
                        <img  data-aos="fade-up" src="{{asset('images/dl380.jpg')}}" alt="">
                        ...
                        <img data-aos="fade-up" src="{{asset('images/dlMicrosoft.png')}}" alt="">
